...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // Custom theme colors (mapped to Shadcn's CSS variables)
        'theme-bg-primary': 'var(--color-bg-primary)',
        'theme-text-primary': 'var(--color-text-primary)',
        'theme-primary-main': 'var(--color-primary-main)',
        'theme-primary-hover': 'var(--color-primary-hover)',
        'theme-secondary-main': 'var(--color-secondary-main)',
        ...
        // Shadcn UI colors (will be overridden by our theme variables)
